...
if doplot
    colors = lines(2);
    fig13 = figure('Units', 'inches', 'Position', [0.1, 0.1, 8, 6]);
    hold on;
    ...
    saveFigureSet(fig13, fullfile(figdir, 'figure-13-high-rate-calibration-at-2C'));
    figureData = struct('experiment', struct('time_h', expdata.time(:)' / hour, ...
        'voltage_v', expdata.U(:)'), ...
        'initial', struct('time_h', getTime(output0.states) / hour, ...
        'voltage_v', getE(output0.states)), ...
        'calibrated', struct('time_h', getTime(outputOpt.states) / hour, ...
        'voltage_v', getE(outputOpt.states)));
    writeStruct(figureData, fullfile(figdir, 'figure-13-high-rate-calibration-at-2C.json'));
end
...
if hessian
    ...
    plotHessianEigenvectors(Hscaled, HRC.shortnames, 'BFGS', ...
                            'dosave', dosave, ...
                            'titlestr', 'Hessian eigenvectors and eigenvalues');
