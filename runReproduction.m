...
fprintf('Stage 3/5: Initial parameter sensitivities (Figure 15)\n');
run(fullfile('scripts', 'high-rate-calibration', 'plotSensitivities.m'));

fprintf('Stage 4/5: High-rate calibration (Figures 13 and 16)\n');
run(fullfile('scripts', 'high-rate-calibration', 'runHighRateCalibration.m'));

fprintf('Stage 5/5: Validation (Figure 14)\n');
